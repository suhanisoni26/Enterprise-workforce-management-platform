...
export const EmptyState = ({
  ...
  <div className="flex flex-col items-center justify-center text-center py-16 px-6 animate-fade-in">
    ...
    <h3 className="text-sm font-semibold text-[#111111] mb-1.5">{title}</h3>
...
export const ErrorState = ({
  ...
  <div className="flex flex-col items-center justify-center text-center py-16 px-6 animate-fade-in">
    ...
    {onRetry && (
      <button
        onClick={onRetry}
        className="mt-6 inline-flex items-center gap-2 px-4 py-2.5 rounded-lg text-[11px] font-bold uppercase tracking-wider text-[#111111] border border-[rgba(148,163,184,0.16)] hover:bg-white/5 transition-colors"
      >
...
export const LoadingSpinner = ({ label = 'Loading...', size = 'md' }) => {
  ...
  return (
    <div className="flex flex-col items-center justify-center gap-3 py-16">
      <svg className={`animate-spin ${dims} text-[#000000]`} viewBox="0 0 24 24" fill="none">
