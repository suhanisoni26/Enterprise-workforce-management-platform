...
const ComingSoon = ({ icon: Icon, eyebrow, title, description }) => (
  <div className="space-y-8">
    <div>
      <p className="text-[10px] font-bold uppercase tracking-widest text-[#000000] mb-1.5">{eyebrow}</p>
      <h1 className="text-3xl font-bold text-[#111111]" style={{ fontFamily: 'var(--font-display)' }}>
        {title}
      </h1>
    </div>
    ...
    <Card className="text-center py-16">
      ...
      >
        {Icon && <Icon className="w-7 h-7 text-[#000000]" />}
      </div>
      <h2 className="text-lg font-semibold text-[#111111] mb-2">Module in progress</h2>
